...
Sidebar readiness now requires both complete native sidebar/command frame sets and the menu rail. Older disk output
can use the converter’s `--sidebar-only` upgrade; browser schema 5 reparses the
