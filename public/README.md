...
Sidebar readiness now requires both complete native frame sets. Older disk output
can use the converter’s `--sidebar-only` upgrade; browser schema 3 reparses the
