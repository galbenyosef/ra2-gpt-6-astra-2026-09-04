...
const sampleRoot=path.join(repo,'assets/hd/models/apocalypse-tank');
const samples={low:path.join(sampleRoot,'30k.glb'),draco:path.join(sampleRoot,'200k-draco.glb'),webp:path.join(sampleRoot,'80k-webp.glb')};
